        ...
        var a = n("./node_modules/@angular/core/esm5/core.js"),
            ...
            f = function() {
                function e(e, t, n, a, r, s, i, c) {
                    this.http = e, this.cacheService = t, this.cookieService = n, this.modalService = a, this.injector = r, this.platformId = s, this.document = i, this.forwardedHost = c, Object(d.isPlatformServer)(this.platformId) ? void 0 === this.forwardedHost || null == this.forwardedHost || (-1 !== this.forwardedHost.indexOf("citvian.org") ? this.apiUrl = "https://api.citvian.org/v1/" : -1 !== this.forwardedHost.indexOf("turbotra.ir") ? this.apiUrl = "http://api.turbotra.ir/v1/" : -1 !== this.forwardedHost.indexOf("turbotra.com") ? this.apiUrl = "https://api.turbotra.com/v1/" : -1 !== this.forwardedHost.indexOf("kingstorm.net") ? this.apiUrl = "https://api.kingstorm.net/v1/" : -1 !== this.forwardedHost.indexOf("molon-lave.net") ? this.apiUrl = "https://api.molon-lave.net/v1/" : -1 !== this.forwardedHost.indexOf("travian-wars.com") ? this.apiUrl = "https://api.travian-wars.com/v1/" : -1 !== this.forwardedHost.indexOf("xravian.online") ? this.apiUrl = "https://api.xravian.online/v1/" : -1 !== this.forwardedHost.indexOf("tstravian.ir") ? this.apiUrl = "http://api.tstravian.ir/v1/" : -1 !== this.forwardedHost.indexOf("speedtra.com") ? this.apiUrl = "https://api.speedtra.com/v1/" : -1 !== this.forwardedHost.indexOf("travian.live") ? this.apiUrl = "https://api.travian.live/v1/" : console.log("Could not detect api url")) : this.apiUrl = this.document.location.protocol + "//api." + this.document.location.hostname.replace("www.", "") + "/v1/", (null === this.apiUrl || void 0 === this.apiUrl || this.apiUrl.length <= 0 || -1 !== this.apiUrl.indexOf("localhost") || -1 !== this.apiUrl.indexOf("127.0.0.1")) && (this.apiUrl = "https://api.xravian.online/v1/"), o.a.production || this.cacheService.removeAll()
                }
